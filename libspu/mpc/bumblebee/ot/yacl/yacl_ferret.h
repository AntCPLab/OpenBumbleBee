...
class YaclSpokenSoftOt;

class YaclFerretOt : public spu::mpc::bumblebee::FerretOtInterface {
 private:
  // YaclSpokenSoftOt re-uses the Impl
  friend class YaclSpokenSoftOt;
...
class YaclSpokenSoftOt : public spu::mpc::bumblebee::FerretOtInterface {
 private:
  std::shared_ptr<YaclFerretOt::Impl> impl_;

 public:
  YaclSpokenSoftOt(std::shared_ptr<Communicator> conn, bool is_sender);
