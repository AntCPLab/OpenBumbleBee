...
//
#include "libspu/mpc/bumblebee/arith/conv2d_prot.h"

#include "seal/evaluator.h"

#include "libspu/core/xt_helper.h"
#include "libspu/mpc/bumblebee/arith/conv2d_helper.h"
#include "libspu/mpc/bumblebee/arith/tensor_encoder.h"
#include "libspu/mpc/bumblebee/rlwe/utils.h"
#include "libspu/mpc/utils/ring_ops.h"

template <>
struct std::hash<spu::mpc::bumblebee::Conv2DProtocol::Meta> {
  size_t operator()(
      const spu::mpc::bumblebee::Conv2DProtocol::Meta &s) const noexcept {
