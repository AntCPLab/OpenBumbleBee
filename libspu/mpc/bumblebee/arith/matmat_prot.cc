...
#include "libspu/mpc/bumblebee/arith/vector_encoder.h"
#include "libspu/mpc/bumblebee/rlwe/lwe_ct.h"
#include "libspu/mpc/bumblebee/rlwe/utils.h"
#include "libspu/mpc/utils/ring_ops.h"

template <>
struct std::hash<spu::mpc::bumblebee::MatMatProtocol::Meta> {
  size_t operator()(
      const spu::mpc::bumblebee::MatMatProtocol::Meta& s) const noexcept {
    using namespace spu::mpc::bumblebee;
...
Shape3D MatMatProtocol::GetSubMatShape(const Meta& meta, int64_t poly_deg,
  ...
  const double bandwidth_price = 200.0;
...
NdArrayRef MatMatProtocol::ParseBatchRLWEResult(
...
NdArrayRef MatMatProtocol::ParseLWEResult(
...
void MatMatProtocol::ExtractLWEs(const Meta& meta,
